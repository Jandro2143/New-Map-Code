...
var T = class {
  ...
  setScript() {
    ...
    Object.keys(s).forEach(
      ...
      m = m[u] || (m[u] = {});
      const f = m.maps || (m.maps = {}), g = /* @__PURE__ */ new Set(), v = new URLSearchParams(), w = () => a || (a = new Promise((_, E) => Fe(this, void 0, void 0, function* () {
        var b;
    ...
    return provide(Le, r), watch(
      ...
      () => {
        ...
        o.value && (r.value = markRaw(
          new _t({
            map: o.value,
            algorithm: new mt((_a = n3.options.algorithmOptions) != null ? _a : {}),
            ...n3.options
          })
        ), be.forEach((l) => {
          var i;
